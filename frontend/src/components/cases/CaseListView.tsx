...
export const CaseListView: React.FC<CaseListViewProps> = ({
  ...
  const categories: string[] = ['All', 'Criminal', 'Civil', 'Family', 'Consumer', 'Special / Statutory'];
  ...
  const filteredCases = cases.filter(c => {
    ...
    const matchesSearch = 
      ...
      c.assignedLawyer.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    <div className="p-8 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          {['All', 'Active', 'Pending', 'Disposed'].map((st) => (
            <button
              key={st}
