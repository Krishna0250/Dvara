...
export const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col justify-between border-r border-slate-800 h-screen sticky top-0 select-none z-20">
      <div>
        {
    /* Brand Header */
  }
    ...
    return <button
      ...
      className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-sm font-medium transition-all ${isActive ? "bg-indigo-600/90 text-white shadow-md shadow-indigo-900/40 font-semibold" : "text-slate-400 hover:text-slate-200 hover:bg-slate-800/60"}`}
    >
